...
export default function GrammarPanel() {
  ...
  return (
    <div className="grammar-page">
      ...
      <style jsx>{`
        .grammar-page { max-width: 720px; margin: 0 auto; }
        .grammar-subtitle { color: var(--text-muted); font-size: 0.9rem; margin: 0 0 20px; }
        .grammar-empty { text-align: center; padding: 60px 20px; background: var(--bg-elevated); border: 1px solid var(--border); border-radius: 20px; }
        ...
        .grammar-item { background: var(--bg-elevated); border: 1px solid var(--border); border-radius: 16px; overflow: hidden; }
        .grammar-item-head {
